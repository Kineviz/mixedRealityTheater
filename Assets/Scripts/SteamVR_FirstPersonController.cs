...
public class SteamVR_FirstPersonController : MonoBehaviour
{
	...
	private Color canGrabObjectOriginalColor;
	...
	void ToggleGrabbableObjectHighlight(bool highlightObject)
	{
		if (highlightGrabbableObject && canGrabObject != null)
		{
			if (highlightObject)
			{
				canGrabObject.gameObject.GetComponent<Renderer>().material.color = grabObjectHightlightColor;
			}
			else
			{
				canGrabObject.gameObject.GetComponent<Renderer>().material.color = canGrabObjectOriginalColor;
			}
		}
	}
	...
	void OnTriggerEnter(Collider collider)
	{
		if (collider.tag == "Grabbable")
		{
			...
			canGrabObjectOriginalColor = canGrabObject.gameObject.GetComponent<Renderer>().material.color;
